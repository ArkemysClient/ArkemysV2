package com.rastiq.arkemys.cosmetics;

import com.rastiq.arkemys.Client;
import com.rastiq.arkemys.database.Database;
import com.rastiq.arkemys.*;
import com.rastiq.arkemys.database.*;
                    ...
                    if (result != null) {
                        while (result.next()) {
                            ...
                            if (cosmeticList.contains(CosmeticList.CAPES)) {
                                ...
                                capeTexture = new ResourceLocation(sb.append("arkemys/capes/").append(getCapeName(data)).append(".png").toString());
                            }
                            else {
                                capeTexture = null;
                            }
