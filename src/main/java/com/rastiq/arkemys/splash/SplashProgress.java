package com.rastiq.arkemys.splash;
...
public class SplashProgress {
    ...
    // Font renderer
    private static SplashFontRenderer raleway;
    private static SplashFontRenderer roboto;
    ...
    public static void drawSplash(TextureManager tm) {
        ...
        if (splash == null) splash = new ResourceLocation("arkemys/splash/splash.png");
    ...
    private static void drawProgress() {
        ...
        if (raleway == null) raleway = new SplashFontRenderer("Raleway", 20);;
        if (roboto == null) roboto = new SplashFontRenderer("Roboto", 20);;
