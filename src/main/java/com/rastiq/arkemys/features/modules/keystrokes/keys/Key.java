...
import com.rastiq.arkemys.utils.ColorObject;
...
public class Key
{
    ...
    public void render() {
        ...
        final float pressModifier = Math.min(1.0f, (System.currentTimeMillis() - this.pressTime) / 1);
    ...
    protected boolean pressed() {
        ...
        this.faded = (System.currentTimeMillis() - this.pressTime) / 1;
