package com.rastiq.arkemys.gui.elements.settings.color;

import com.rastiq.arkemys.gui.GuiScreen;
import com.rastiq.arkemys.gui.elements.Checkbox;
import com.rastiq.arkemys.gui.elements.Slider;
...
public class SettingElementColor extends SettingElement
{
    public int color;
    public int alpha;
    public final com.rastiq.arkemys.gui.elements.Checkbox chroma;
    ...
    public SettingElementColor(final int x, final int y, final int width, final int height, final int xOffset, final int yOffset, final Setting setting, final Consumer update, final BiConsumer<Setting, SettingElement> consumer, final GuiScreen parent) {
        ...
        this.chromaSpeed = new Slider(this.getX() - 132 - 70, this.getY() + 12, 50, 5, 0.0f, 80.0f, 1.0f, setting.getColorObject().getChromaSpeed(), "Vitesse", null, parent);
